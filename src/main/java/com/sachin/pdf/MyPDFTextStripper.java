...
public class MyPDFTextStripper extends PDFTextStripper
{
    ...
    protected void writeString(String text, List<TextPosition> textPositions) throws IOException
    {
        ...
        for (TextPosition textPosition : textPositions)
        {
            ...
            if (annotation != null)
            {
                ...
                else if (currentAnnot.getAnnotationName()!=null&&!currentAnnot.getAnnotationName().equals(annotation.getAnnotationName()))
                {
            ...
            newText.append(textPosition.getUnicode());
        }
    ...
    private PDAnnotation getAnnotation(TextPosition textPosition)
    {
        ...
        float textY1 = currentPage.getMediaBox().getHeight() - textPosition.getY();
